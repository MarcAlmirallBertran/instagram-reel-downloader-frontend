...
function OpenAISettingsCard() {
  const { data: settings, isLoading } = useOpenAISettings()
  const updateSettings = useUpdateOpenAISettings()
  ...
  return (
    <Card>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <CardFooter>
          <Button type="submit" disabled={updateSettings.isPending || !apiKey}>
...
function InstagramSettingsCard() {
  const { data: settings, isLoading } = useInstagramSettings()
  const updateSettings = useUpdateInstagramSettings()
  ...
  useEffect(() => {
    if (settings) {
      ...
      setPassword(settings.instagram_password || '')
    }
  }, [settings])
  ...
  return (
    <Card>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <CardFooter>
          <Button type="submit" disabled={updateSettings.isPending || (!username && !password)}>
            {updateSettings.isPending ? (
              'Saving...'
            ) : saved ? (
              <>
